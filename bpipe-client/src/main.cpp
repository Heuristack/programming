...
//  market_depth_subscriber.subscribe("1288 HK Equity", "BEST_BID1, BEST_ASK1");
    ...
    market_data_subscriber.subscribe("//blp/mktdata/bbgid/BBG000JB5HR2",
                                     "BEST_BID, BEST_ASK, "
                                         ...
                                         "MKTDATA_EVENT_TYPE, MKTDATA_EVENT_SUBTYPE, EVT_TRADE_IDENTIFIER_RT, EVT_TRADE_INTEGER_IDENTIFIER_RT,"
                                         "LAST_ASK_TIME_TODAY_REALTIME, LAST_BID_TIME_TODAY_REALTIME, LAST_PRICE_TIME_TODAY_REALTIME, LAST_TRADE_PRICE_TIME_TODAY_RT, THEORETICAL_TIME_TODAY_RT,"
